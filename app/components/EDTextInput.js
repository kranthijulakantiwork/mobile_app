...
class EDTextInput extends Component {
  ...
  render() {
    let textInputStyle = Object.assign(
      {
        width: (width - 40), height: 40, fontSize: 15, color: COLORS.GRAY,
        margin: 0, padding: 0, paddingLeft: 25, borderRadius: 20,
        borderBottomWidth: 1, borderColor: COLORS.APP_THEME_PURPLE
      },
